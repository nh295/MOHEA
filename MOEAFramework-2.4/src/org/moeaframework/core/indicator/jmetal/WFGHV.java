...
//
//  public int getLessContributorHV(Population pop) {
//
//    Front wholeFront   = new Front();
//
//    wholeFront.loadFront(pop, -1);
//
//    int index= 0;
//    double contribution = Double.POSITIVE_INFINITY;
//
//    for (int i = 0; i < pop.size(); i++) {
//      double [] v = new double[pop.get(i).getNumberOfObjectives()];
//      for (int j = 0; j < v.length; j++){
//        v[j] = pop.get(i).getObjective(j);
//      }
//      Point p = new Point(v);
...
//        contribution = aux;
//      }
//      pop.get(i).setCrowdingDistance(aux);
//    }
//
//    return index;
//  }
