...
<<<<<<< HEAD
            [fHV,IGD,finalHV,finalIGD,ET] = getAllResults(strcat(path,filesep,'Experiment A Data'),selectors{j},creditDef{i},problemName{k});

=======
            [fHV,IGD,finalHV,finalIGD,ET] = getAllResults(strcat(path,filesep,'OPDoResults'),selectors{j},creditDef{i},problemName{k});
>>>>>>> d5026fe35a65fcc50ede21b5749cc77bc261467f
            if(isempty(ET))
