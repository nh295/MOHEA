...
%     'DTLZ1','DTLZ2','DTLZ3','DTLZ4','DTLZ5','DTLZ6','DTLZ7',...
    'WFG7'};%,'WFG2','WFG3','WFG4','WFG5','WFG6','WFG7','WFG8','WFG9'};
% problemName = {%'UF1','UF2','UF3','UF4','UF5','UF6','UF7','UF8','UF9','UF10',...
...
creditDef = {'pcx+pm','undx+pm','spx+pm'};
...
%         figure
        for k=1:length(problemName)
            [fHV,IGD,finalHV,finalIGD,ET] = getAllResults(strcat(path,filesep,'resultsMac'),selectors{j},creditDef{i},problemName{k});
            if(isempty(ET))
